<template>
	<view>
		...
		<uni-forms :rules="rules" :value="formData" ref="form" validate-trigger="bind" err-show-type="undertext">
			<uni-card title="基本信息" top="0">
				 <uni-forms-item name="name" required label="用户名">
					<uni-easyinput type="text" :inputBorder="true" v-model="formData.name_1" placeholder="请输入用户名"></uni-easyinput>
				</uni-forms-item> 
...
<script>
	export default {
		data() {
			return {
				name:'birth1232342115354343543532',
				formData: {
					name: '',
					age: '',
					email: '',
